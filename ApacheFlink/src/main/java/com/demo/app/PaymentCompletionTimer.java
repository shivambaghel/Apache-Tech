...
public class PaymentCompletionTimer {public static void main(String[] args) throws Exception {

    StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
    DataStream<PaymentDataCase2> payments = env.addSource(new CompletionDataGenerator());
    payments.print();
    payments.writeAsText("C://User/18-Feb/PaymentCompleteTimeInput.txt",
    ...
    newStream.writeAsText("C://User/18-Feb/PaymentCompleteTimeInput.txt", FileSystem.WriteMode.OVERWRITE).setParallelism(1);
    env.execute();
}
}
