...
import com.demo.datagenerator.CompletionDataGenerator;
...
public class PaymentCompletionTimerAdv {
    public static void main(String[] args) throws Exception {
        ...
        payments.print();
        payments.writeAsText("C://Users/18-Feb/PaymentCompleteTimeAdvInput.txt", FileSystem.WriteMode.OVERWRITE).setParallelism(1);

        DataStream<Tuple2<String, Long>> completionInterval = payments
                .keyBy(PaymentDataCase2::getComponentId)
        ...
        finalInterval.print();
        finalInterval.writeAsText("C://Users/18-Feb/PaymentCompleteTimeAdvOutput.txt",FileSystem.WriteMode.OVERWRITE).setParallelism(1);

        newStream.writeAsText("C://Users/18-Feb/PaymentCompleteTimeAlertAdvOutput.txt",FileSystem.WriteMode.OVERWRITE).setParallelism(1);
