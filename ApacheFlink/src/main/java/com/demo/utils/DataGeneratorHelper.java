...
import com.demo.model.ApplicationNames;
...
public class DataGeneratorHelper {
    ...
    public static ApplicationNames getRandomAppName() {
        return ApplicationNames.values()[RANDOM.nextInt(ApplicationNames.values().length)];
    }
    ...
    public static Date generateTime() {
        int offsetMins = RandomNumberGenerator.getRandomNumber(0, 5);
        return DateUtils.addMinutes(new Date(), offsetMins);
    }
